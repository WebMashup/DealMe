...
public interface DealService extends RemoteService {
	...
	ArrayList<Deal> getYipitDeals(LatLngCoor coor, Double radius, Integer limit, Integer offset, ArrayList<Category> tags);	// Get yelp reviews for a business by phone number
